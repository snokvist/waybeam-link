...
| RK3566 ground | `192.168.2.199` / 10 | Radxa ZERO 3, RTL8812CU `0bda:c812`, `wlx40a5ef2f229b`, `rtl88x2cu` | `/usr/bin/waybeam-link`, `/etc/waybeam-link/ground.json`, `/etc/init.d/S49waybeam-link` |
| Ethernet cache | `192.168.2.247` / 33 | Intel Celeron J4125 Debian host, MT7921 `14c3:7961` (`wlp3s0`, `mt7921e`) and RTL8812AU `0bda:8812` (`wlx200db0c4a76a`, `rtl88xxau_wfb`) | `/usr/local/bin/waybeam-link`, `/etc/waybeam-link/cache.json`, `waybeam-cache.service` |
