...
void format_stats_line(const StatsSnapshot& snap, std::string& out) {
    ...
    append_escaped(out, snap.link.transition_reason);
    out += ",\"loss_window_milli\":";
    append_u64(out, snap.link.loss_window_milli);
    out += ",\"loss_ewma_milli\":";
    append_u64(out, snap.link.loss_ewma_milli);
    out += ",\"loss_uniq\":";
    append_u64(out, snap.link.loss_uniq);
    out += ",\"loss_score\":";
    ...
    append_u64(out, snap.link.selector_state_age_ms);
    out += ",\"lockout_active\":";
    append_bool(out, snap.link.lockout_active);
    out += ",\"lockout_latched\":";
    append_bool(out, snap.link.lockout_latched);
    out += ",\"lockout_profile\":";
    append_u64(out, snap.link.lockout_profile);
    out += ",\"lockout_ceiling_profile\":";
    append_u64(out, snap.link.lockout_ceiling_profile);
    out += ",\"lockout_remaining_ms\":";
    append_u64(out, snap.link.lockout_remaining_ms);
    out += ",\"lockout_strikes\":";
    append_u64(out, snap.link.lockout_strikes);
    out += ",\"lockout_active_mask\":";
    append_u64(out, snap.link.lockout_active_mask);
    out += ",\"lockout_latched_mask\":";
    append_u64(out, snap.link.lockout_latched_mask);
    out += ",\"lockout_conflict\":";
    append_bool(out, snap.link.lockout_conflict);
    out += ",\"flap_freeze\":";
    append_bool(out, snap.link.flap_freeze);
    out += ",\"csa_state\":";
    append_escaped(out, snap.link.csa_state);
    out += ",\"csa_accepted\":";
    append_u64(out, snap.link.csa_accepted);
    out += ",\"csa_no_key\":";
    append_u64(out, snap.link.csa_no_key);
    out += ",\"csa_bad_mac\":";
    append_u64(out, snap.link.csa_bad_mac);
    out += ",\"csa_issuer_lock\":";
    append_u64(out, snap.link.csa_issuer_lock);
    out += ",\"csa_nonce_replay\":";
    append_u64(out, snap.link.csa_nonce_replay);
    out += ",\"csa_not_allowlisted\":";
